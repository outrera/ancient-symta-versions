...
(defcfun ("Mix_Linked_Version" Linked-Version) sdl::sdl-version)
...
(defun SDL-MIXER-VERSION (sdl-version)
  (cffi:with-foreign-slots ((sdl::major sdl::minor sdl::patch) sdl-version sdl::sdl-version)
...
#-(or little-endian PC386 X86 I386) (defconstant +DEFAULT-FORMAT+ sdl::AUDIO-S16MSB) ;; Big Endian
#+(or little-endian PC386 X86 I386) (defconstant +DEFAULT-FORMAT+ sdl::AUDIO-S16LSB) ;; Little Endian

(defun Load-WAV (file)
  (Load-WAV-RW (sdl::SDL-RW-FROM-FILE file "rb") 1))
